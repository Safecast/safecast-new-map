...
const docTemplateunifiedapi = `{
    ...
    "paths": {
        ...
        "/api/admin/cache": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Cache action (e.g. clear, stats)",
                        "name": "action",
                        "in": "query"
                    }
                ],
        ...
        "/api/admin/delete-multiple": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Bulk delete request payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/admin/import-from-safecast": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Streaming progress",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/admin/mcp/delete": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Delete all filtered rows",
                        "name": "all",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search term when all=true",
                        "name": "search",
                        "in": "query"
                    }
                ],
        ...
        "/api/admin/translations/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Translation row ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/admin/uploads": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by internal user ID",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
        ...
        "/extreme": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "highest",
                        "description": "Direction: 'highest' or 'lowest'",
                        "name": "direction",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        "type": "number",
                        "default": -90,
                        "description": "Southern boundary for geographic filter",
                        "name": "min_lat",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "default": 90,
                        "description": "Northern boundary for geographic filter",
                        "name": "max_lat",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "default": -180,
                        "description": "Western boundary for geographic filter",
                        "name": "min_lon",
                        "in": "query"
                    },
                    {
                        "type": "number",
                        "default": 180,
                        "description": "Eastern boundary for geographic filter",
                        "name": "max_lon",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated device IDs to exclude (e.g., 'bGeigie-2113,bGeigie-456')",
                        "name": "exclude_devices",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "JSON array of bounding boxes to exclude (e.g., '[{\\",
                        "name": "exclude_areas",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Extreme readings with location details",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/get_markers": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Requested map zoom",
                        "name": "zoom",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Single track ID filter",
                        "name": "trackID",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated track IDs filter",
                        "name": "trackIDs",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated speed categories",
                        "name": "speeds",
                        "in": "query"
                    },
                    {
        ...
        "/gpt/area": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Compact reading list",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/realtime_history": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Realtime device ID",
                        "name": "device",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Realtime history payload",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "404": {
                        "description": "Realtime feature disabled",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/stream_markers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Set to msgpack for binary stream",
                        "name": "format",
                        "in": "query"
                    }
                ],
        ...
        "/upload/progress": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Upload tracking ID returned by /upload",
                        "name": "trackid",
                        "in": "query",
                        "required": true
                    }
    ...
    "tags": [
        {
            "description": "Core /api dataset and track endpoints",
            "name": "core"
        },
        {
            "description": "Web utility endpoints used by the map UI",
            "name": "web"
        },
        {
        ...
        {
            "description": "Map data and streaming endpoints",
            "name": "map"
        }
    ]
}`

// SwaggerInfounifiedapi holds exported Swagger Info so clients can modify it
var SwaggerInfounifiedapi = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8765",
	BasePath:         "/",
	Schemes:          []string{"http", "https"},
	Title:            "Safecast Unified Server API",
	Description:      "Unified API documentation generated from Swaggo annotations in the unified server, HTTP API, and auth packages.",
	InfoInstanceName: "unifiedapi",
	SwaggerTemplate:  docTemplateunifiedapi,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInfounifiedapi.InstanceName(), SwaggerInfounifiedapi)
}
