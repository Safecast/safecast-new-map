[![नवीनतम स्थिर बिल्ड](https://github.com/Safecast/safecast-new-map/actions/workflows/release.yml/badge.svg)](https://github.com/Safecast/safecast-new-map/actions/workflows/release.yml)
...
ऑनलाइन डेमो: [https://simplemap.safecast.org/](https://simplemap.safecast.org/) — आपका नोड भी ऐसा ही दिखेगा।

👉 [एकीकृत डाउनलोड पृष्ठ](https://github.com/Safecast/safecast-new-map/releases) (सभी प्लेटफ़ॉर्म, नवीनतम बिल्ड)
...
1) [रिलीज़ पृष्ठ](https://github.com/Safecast/safecast-new-map/releases) खोलें और अपने सिस्टम के लिए बिल्ड डाउनलोड करें।
...
2) Docker Hub पर **Safecast/safecast-new-map** खोजें और **Run** पर क्लिक करें (या यह कमांड चलाएं):
```bash
...
- simplemap.safecast.org का प्रतिबिंब चाहिए? एक बार `safecast-new-map -import-tgz-url https://simplemap.safecast.org/api/json/weekly.tgz` चलाएँ — यह साप्ताहिक आर्काइव डाउनलोड करेगा, डेटाबेस भरेगा और बंद हो जाएगा ताकि अगली बार शुरू होते ही डेटा उपलब्ध हो।
- पहले आर्काइव डाउनलोड करना पसंद है? [https://simplemap.safecast.org/api/json/weekly.tgz](https://simplemap.safecast.org/api/json/weekly.tgz) लें, `-import-tgz-path /path/to/weekly.tgz` के साथ चलाएँ और अपनी लोकल प्रति का उपयोग करें।
...
- **PostgreSQL (`pgx`)** — सबसे तेज़, कई उपयोगकर्ताओं के लिए उपयुक्त। उदाहरण: `safecast-new-map -db-type pgx -db-conn postgres://USER:PASS@HOST:PORT/DATABASE?sslmode=allow -import-tgz-url https://simplemap.safecast.org/api/json/weekly.tgz`
- **DuckDB / SQLite / Chai** — एकल उपयोगकर्ता के लिए फ़ाइल-आधारित समाधान। समानांतर लिखावट से टकराव हो सकते हैं, इसलिए व्यक्तिगत मानचित्रों के लिए रखें। उदाहरण: `safecast-new-map -db-type duckdb -import-tgz-url https://simplemap.safecast.org/api/json/weekly.tgz`
...
Safecast‑Isotope‑Map को **Dmitry Ignatenko** के फील्ड शोध से प्रेरणा मिली और **Rob Oudendijk** तथा **Safecast** से गहरा प्रभाव। AtomFast और Radiacode समुदायों के खुले डेटा इसे उपयोगी बनाए रखते हैं। यदि यह मानचित्र किसी की भी जान बचा सके, तो यह व्यर्थ नहीं बना।
