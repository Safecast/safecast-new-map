...
// RootRails is the Rails-compatible root API descriptor (name, uri, subresource_uris).
...
// CountRails is the Rails-compatible count response for GET /count.
type CountRails struct {
	Count int64 `json:"count"`
}

// ErrorsRails is the Rails-compatible validation error envelope (e.g. POST measurement 422).
